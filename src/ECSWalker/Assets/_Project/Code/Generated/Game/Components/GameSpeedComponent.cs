...
public partial class GameEntity {
    ...
    public ECSWalker.Gameplay.Movement.Speed speed { get { return (ECSWalker.Gameplay.Movement.Speed)GetComponent(GameComponentsLookup.Speed); } }
    ...
    public GameEntity AddSpeed(float newValue) {
        ...
        var component = (ECSWalker.Gameplay.Movement.Speed)CreateComponent(index, typeof(ECSWalker.Gameplay.Movement.Speed));
